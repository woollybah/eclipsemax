...
public class ASTUtils {
	...
	public static ASTNode getEnclosingElement(Class element, ASTNode[] wayToNode,
	...
	public static ModuleDeclaration getAST(char[] cs) {
		ISourceParser sourceParser = DLTKLanguageManager
		    .getSourceParser(BlitzMaxNature.BLITZMAX_NATURE);
	...
	public static boolean isNodeScoping(ASTNode node) {
		// FIXME
		return (
//				node instanceof RubyIfStatement
