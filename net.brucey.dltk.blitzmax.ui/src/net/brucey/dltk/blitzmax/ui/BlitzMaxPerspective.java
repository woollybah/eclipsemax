...
public class BlitzMaxPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		// new actions - BlitzMaxproject creation wizard
		layout
		    .addNewWizardShortcut("net.brucey.dltk.blitzmax.ui.wizards.BlitzMaxProjectWizard"); //$NON-NLS-1$
