...
public class BlitzMaxVariableLabelProvider extends VariableLabelProvider
  ...
  public BlitzMaxVariableLabelProvider() {
  ...
  protected String getColumnText(IVariable variable, IValue value,
    ...
    if (BlitzMaxVariableColumnPresentation.COLUMN_INSTANCE_ID.equals(columnId)) {
